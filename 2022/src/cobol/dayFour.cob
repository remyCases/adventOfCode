       ...
       *> This file is part of adventOfCode project from https://github.com/remyCases/adventOfCode.
       ...
       Main.
           ...
           FUNCTION TRIM(WS-OverlapDisplay, LEADING)
       EXIT PROGRAM.
       ...
       BranchingCompute.
           ...
           IF L-Part EQUALS TO 1
               ...
               *> case A B B A
               IF WS-FirstStartRange <= WS-SecondStartRange
               AND WS-SecondEndRange <= WS-FirstEndRange
                   MOVE 1 TO WS-IncrementOverlap
               END-IF
       
               *> case B A A B
               IF WS-SecondStartRange <= WS-FirstStartRange
               AND WS-FirstEndRange <= WS-SecondEndRange
                   MOVE 1 TO WS-IncrementOverlap
               END-IF
           END-IF
